<div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="trangchu"><i class="fa fa-dashboard fa-fw icon-mright"></i>Quay lại trang nhập</a>
                        </li>
                        <li>
                            <a href="admin/theloai/danhsach"><i class="fa fa-list fa-fw icon-mright"></i>Địa điểm thí nghiệm<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="admin/theloai/danhsach">Danh Sách</a>
                                </li>
                                <li>
                                    <a href="admin/theloai/them">Thêm địa điểm thí nghiệm</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        ...
                        <li>
                            <a href="admin/loaitin/danhsach"><i class="fa fa-tasks fa-fw icon-mright"></i>Ngày thí nghiệm<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                        ...
                        <li>
                            <a href="admin/tintuc/danhsach"><i class="fa fa-newspaper-o fa-fw icon-mright"></i>Thêm các chi tiết<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>

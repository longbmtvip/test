...
return view('admin.tintuc.danhsach',['tintuc'=>$tintuc]);
    ...
    public function postThem(Request $request){
        $this->validate($request,
            [
                'sub_cate'=>'required',
                'article_title' => 'required|min:0',
                'article_desc' => 'required',
                'article_content'=> 'required|min:0',
            ],
            [
                'sub_cate.required'=>'Bạn chưa chọn Nơi thí nghiệm',
                ...
                'article_content.min'=>'Bài viết quá ngắn, yêu cầu tối thiểu gồm 0 ký tự trở lên!',
            ]);
        $tintuc = new TinTuc;
...
$tintuc = TinTuc::find($id);
    ...
    public function postSua(Request $request,$id){
        ...
        $this->validate($request,
            ...
            [
                'sub_cate.required'=>'Bạn chưa chọn Ngày thí nghiệm!',
                'article_title.required'=>'Bạn chưa nhập Tiêu Đề cho Bài viết!',
